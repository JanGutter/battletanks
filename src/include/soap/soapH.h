...
inline ns1__board * soap_new_req_ns1__board(struct soap *soap) { ns1__board *_p = soap_instantiate_ns1__board(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); } return _p; }

inline ns1__board * soap_new_set_ns1__board(struct soap *soap, std::vector<ns1__stateArray * >& states) { ns1__board *_p = soap_instantiate_ns1__board(soap, -1, NULL, NULL, NULL); if (_p) { _p->soap_default(soap); _p->ns1__board::states = states; } return _p; }
